...
public:
	FReadFileCompleteCallback(UCorePlayerDataStorage* PlayerDataStorage, const FOnReadFileCompleteCallback& callback)
...
public:
	FWriteFileCompleteCallback(UCorePlayerDataStorage* PlayerDataStorage, const FOnWriteFileCompleteCallback& callback)
		: m_PlayerDataStorage(PlayerDataStorage)
		, m_Callback(callback)
	{
	}
