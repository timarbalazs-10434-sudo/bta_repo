...
public:
	...
	FEOSPlayerDataStorageFileMetadata(const EOS_PlayerDataStorage_FileMetadata& data)
		...
		, UnencryptedDataSizeBytes(data.UnencryptedDataSizeBytes)
	{
		const FUTF8ToTCHAR FilenameChar(data.Filename);
		Filename = FilenameChar.Get();
	}
};
...
public:
	FFileCompleteCallback(const FOnQueryFileCompleteCallback& callback)
		: m_Callback(callback)
	{
	}
	virtual ~FFileCompleteCallback()
	{
		m_Callback.Unbind();
	}
};
...
public:
	FFileListCompleteCallback(const FOnQueryFileListCompleteCallback& callback)
		: m_Callback(callback)
	{
	}
	virtual ~FFileListCompleteCallback()
	{
		m_Callback.Unbind();
	}
};
...
public:
	FDuplicateFileCompleteCallback(const FOnDuplicateFileCompleteCallback& callback)
		: m_Callback(callback)
	{
	}
	virtual ~FDuplicateFileCompleteCallback()
	{
		m_Callback.Unbind();
	}
};
...
public:
	FDeleteFileCompleteCallback(const FOnDeleteFileCompleteCallback& callback)
		: m_Callback(callback)
	{
	}
	virtual ~FDeleteFileCompleteCallback()
	{
		m_Callback.Unbind();
	}
};
...
{
public:
	UCorePlayerDataStorage* m_PlayerDataStorage;
	FOnReadFileCompleteCallback m_Callback;
	FOnFileTransferProgressUpdated m_OnFileTransferProgressUpdated;
public:
	FReadFileCompleteCallback(UCorePlayerDataStorage* PlayerDataStorage, const FOnReadFileCompleteCallback& callback, const FOnFileTransferProgressUpdated& progress)
		: m_PlayerDataStorage(PlayerDataStorage)
		, m_Callback(callback)
		, m_OnFileTransferProgressUpdated(progress)
	{
	}
	virtual ~FReadFileCompleteCallback()
	{
		m_Callback.Unbind();
		m_OnFileTransferProgressUpdated.Unbind();
	}
};
...
public:
	...
	FOnFileTransferProgressUpdated m_OnFileTransferProgressUpdated;
public:
	FWriteFileCompleteCallback(UCorePlayerDataStorage* PlayerDataStorage, const FOnWriteFileCompleteCallback& callback, const FOnFileTransferProgressUpdated& fileTransferProgressUpdated)
		: m_PlayerDataStorage(PlayerDataStorage)
		, m_Callback(callback)
		, m_OnFileTransferProgressUpdated(fileTransferProgressUpdated)
	{
	}
	virtual ~FWriteFileCompleteCallback()
	{
		m_Callback.Unbind();
		m_OnFileTransferProgressUpdated.Unbind();
	}
...
{
public:
	FOnDeleteCacheCompleteCallback m_Callback;
public:
	FDeleteCacheCompleteCallback(const FOnDeleteCacheCompleteCallback& callback)
		: m_Callback(callback)
	{
	}
	virtual ~FDeleteCacheCompleteCallback()
	{
		m_Callback.Unbind();
	}
};
