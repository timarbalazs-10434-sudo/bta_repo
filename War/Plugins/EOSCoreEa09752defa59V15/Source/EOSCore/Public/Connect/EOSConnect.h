...
public:
	...
	static UCoreConnect* GetConnect(UObject* WorldContextObject);
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_Login"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_CreateUser"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_LinkAccount"))
	 ...
	 * @param Callback a callback that is fired when the unlink operation completes, either successfully or in error.
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_UnlinkAccount"))
	...
	* @param Callback a callback that is fired when the create operation completes, either successfully or in error.
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_CreateDeviceId"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_DeleteDeviceId"))
	 ...
	 * @param Callback a callback that is fired when the transfer operation completes, either successfully or in error.
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_TransferDeviceIdAccount"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_QueryExternalAccountMappings"))
	...
	* @param Callback a callback that is fired when the query operation completes, either successfully or in error.
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_QueryProductUserIdMappings"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_GetExternalAccountMapping"))
	...
	* @param OutString The buffer into which the external account ID data should be written. The buffer must be long enough to hold a string of EOS_CONNECT_EXTERNAL_ACCOUNT_ID_MAX_LENGTH.
	*
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_GetProductUserIdMapping"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_GetProductUserExternalAccountCount"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_CopyProductUserExternalAccountByIndex"))
	...
	*         EOS_NotFound if the account data doesn't exist or hasn't been queried yet.
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_CopyProductUserExternalAccountByAccountType"))
	 ...
	 *         EOS_NotFound if the account data doesn't exist or hasn't been queried yet
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_CopyProductUserExternalAccountByAccountId"))
	...
	*         EOS_NotFound if the account data doesn't exist or hasn't been queried yet.
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_CopyProductUserInfo"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_GetLoggedInUsersCount"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_GetLoggedInUserByIndex"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_GetLoginStatus"))
	...
	* @return the enum value of a user's login status.
	*/
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "EOSCore|Connect", meta = (DisplayName = "EOS_Connect_GetLoginStatus (Pure)"))
	...
	*
	* @param Callback a callback that is fired when the authentication is about to expire.
	*
	* @return handle representing the registered callback.
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_AddNotifyAuthExpiration"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_RemoveNotifyAuthExpiration"))
	...
	* @return handle representing the registered callback.
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_AddNotifyLoginStatusChanged"))
	 ...
	 * @param Id handle representing the registered callback
	 */
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_RemoveNotifyLoginStatusChanged"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_CopyIdToken"))
	static EOSResult EOSConnectCopyIdToken(UObject* WorldContextObject, FEOSConnectCopyIdTokenOptions Options, FEOSConnectIdToken& OutIdToken);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "EOSCore|Connect", meta = (WorldContext = "WorldContextObject", DisplayName = "EOS_Connect_VerifyIdToken"))
	static void EOSConnectVerifyIdToken(UObject* WorldContextObject, FEOSConnectVerifyIdTokenOptions Options, const FOnConnectVerifyIdTokenCallback& Callback);

private:
	static void Internal_OnLoginCallback(const EOS_Connect_LoginCallbackInfo* Data);
	static void Internal_OnCreateUserCallback(const EOS_Connect_CreateUserCallbackInfo* Data);
	static void Internal_OnLinkAccountCallback(const EOS_Connect_LinkAccountCallbackInfo* Data);
	static void Internal_OnUnlinkAccountCallback(const EOS_Connect_UnlinkAccountCallbackInfo* Data);
	static void Internal_OnCreateDeviceIdCallback(const EOS_Connect_CreateDeviceIdCallbackInfo* Data);
	static void Internal_OnDeleteDeviceIdCallback(const EOS_Connect_DeleteDeviceIdCallbackInfo* Data);
	static void Internal_OnTransferDeviceIdAccount(const EOS_Connect_TransferDeviceIdAccountCallbackInfo* Data);
	static void Internal_OnQueryExternalAccountMappingsCallback(const EOS_Connect_QueryExternalAccountMappingsCallbackInfo* Data);
	static void Internal_OnQueryProductUserIdMappingsCallback(const EOS_Connect_QueryProductUserIdMappingsCallbackInfo* Data);
protected:
	TMap<FEOSNotificationId, FAuthExpirationCallback*> m_AuthExpirationCallbacks;
	TMap<FEOSNotificationId, FLoginStatusChangedCallback*> m_LoginStatusChangedCallbacks;
};
