...
public:
	...
	FOnTitleStorageFileTransferProgressCallbackDelegate OnProgressCallback;
...
public:
	...
	{
		m_Callback.BindUFunction(this, "HandleCallback");
		m_ProgressCallback.BindUFunction(this, "HandleProgressCallback");
	}

	~UEOSCoreTitleStorageReadFile()
	{
		m_Callback.Unbind();
		m_ProgressCallback.Unbind();
	}
...
private:
	...
	UFUNCTION()
	void HandleProgressCallback(const FEOSTitleStorageFileTransferProgressCallbackInfo& Data)
	{
		OnProgressCallback.Broadcast(Data);
	}
};
