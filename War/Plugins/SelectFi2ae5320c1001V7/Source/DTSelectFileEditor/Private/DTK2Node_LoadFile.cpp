...
// 构造函数
UDTK2Node_LoadFile::UDTK2Node_LoadFile(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
}

// 菜单注册
void UDTK2Node_LoadFile::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
...
// 编译节点
void UDTK2Node_LoadFile::ExpandNode(FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
	...
	{
		// 创建函数回调
		FName FunctionName = GET_FUNCTION_NAME_CHECKED(UDTSelectFileBPLib, OpenFileDialog);
