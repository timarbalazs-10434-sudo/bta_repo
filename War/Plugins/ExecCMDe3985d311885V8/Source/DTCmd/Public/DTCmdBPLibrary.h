...
class UDTCmdBPLibrary : public UBlueprintFunctionLibrary
{
	...
	static void ExecCMD(const UObject* WorldContextObject, const FString & Cmd, EDTCmdCharacter CodePage, bool ErrorOut, FString & Result, struct FLatentActionInfo LatentInfo);
	...
	static void ExecCMDHaveProcess(const UObject* WorldContextObject, const FString & Cmd, EDTCmdCharacter CodePage, bool ErrorOut, const FDTCmdProcess Process, FString & Result, struct FLatentActionInfo LatentInfo);
};
