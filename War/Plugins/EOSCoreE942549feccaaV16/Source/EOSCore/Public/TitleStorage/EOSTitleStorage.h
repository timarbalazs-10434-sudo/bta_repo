...
public:
	...
	*/
	...
	FEOSTitleStorageFileTransferRequestHandle EOSTitleStorageReadFile(UObject* WorldContextObject, FEOSTitleStorageReadFileOptions Options, const FOnTitleStorageReadFileCompleteCallback& Callback, const FOnTitleStorageFileTransferProgressCallback& OnProgressCallback);
