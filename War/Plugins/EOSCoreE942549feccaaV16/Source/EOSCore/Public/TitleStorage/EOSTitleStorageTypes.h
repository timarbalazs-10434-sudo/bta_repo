...
public:
	FQueryFileOptionsCallback(const FOnTitleStorageQueryFileCompleteCallback& callback)
		: m_Callback(callback)
	{
	}
	virtual ~FQueryFileOptionsCallback()
	{
		m_Callback.Unbind();
	}
};
...
public:
	FQueryFileListOptionsCallback(const FOnTitleStorageQueryFileListCompleteCallback& callback)
		: m_Callback(callback)
	{
	}
	virtual ~FQueryFileListOptionsCallback()
	{
		m_Callback.Unbind();
	}
};
...
public:
	FDeleteCacheCallback(const FOnTitleStorageDeleteCacheCompleteCallback& callback)
		: m_Callback(callback)
	{
	}
	virtual ~FDeleteCacheCallback()
	{
		m_Callback.Unbind();
	}
};
...
{
public:
	UCoreTitleStorage* m_TitleStorage;
	FOnTitleStorageReadFileCompleteCallback m_Callback;
	FOnTitleStorageFileTransferProgressCallback m_ProgressCallback;
public:
	FReadFileCallback(UCoreTitleStorage* TitleStorage, const FOnTitleStorageReadFileCompleteCallback& callback, const FOnTitleStorageFileTransferProgressCallback& progressCallback)
		: m_TitleStorage(TitleStorage)
		, m_Callback(callback)
		, m_ProgressCallback(progressCallback)
	{
	}
	virtual ~FReadFileCallback()
	{
		m_Callback.Unbind();
	}
};