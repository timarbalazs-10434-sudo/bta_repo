...
public:
	...
	*/
	...
	void EOSPlayerDataStorageReadFile(UObject* WorldContextObject, FEOSPlayerDataStorageReadFileOptions ReadOptions, const FOnReadFileCompleteCallback& Callback, const FOnFileTransferProgressUpdated& ProgressCallback);
	...
	*/
	...
	void EOSPlayerDataStorageWriteFile(UObject* WorldContextObject, FEOSPlayerDataStorageWriteFileOptions WriteOptions, const FOnWriteFileCompleteCallback& Callback, const FOnFileTransferProgressUpdated& ProgressCallback);
