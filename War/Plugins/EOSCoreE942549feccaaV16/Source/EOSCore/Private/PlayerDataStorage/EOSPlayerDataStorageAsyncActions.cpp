...
{
	Super::Activate();
	UCorePlayerDataStorage::GetPlayerDataStorage(m_WorldContextObject)->EOSPlayerDataStorageReadFile(m_WorldContextObject, m_Options, m_Callback, m_ProgressCallback);
}
...
{
	Super::Activate();
	UCorePlayerDataStorage::GetPlayerDataStorage(m_WorldContextObject)->EOSPlayerDataStorageWriteFile(m_WorldContextObject, m_Options, m_Callback, m_ProgressCallback);
}
