...
#else
		FCStringAnsi::Strncpy(Options.PointerArray[Index], TCHAR_TO_UTF8(*Column.ColumnName), EOSCORE_OSS_STRING_BUFFER_LENGTH + 1);
#endif
...
#else
				FCStringAnsi::Strncpy(StatName, TCHAR_TO_UTF8(*Column.ColumnName), EOSCORE_OSS_STRING_BUFFER_LENGTH + 1);
#endif
...
#else
	FCStringAnsi::Strncpy(LeaderboardId, TCHAR_TO_UTF8(*ReadObject->LeaderboardName), EOSCORE_OSS_STRING_BUFFER_LENGTH + 1);
#endif
